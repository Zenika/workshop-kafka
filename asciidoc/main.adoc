...
7411fae0af98        db-trans-simulator        6 minutes ago       Up 6 minutes
91b7bbce9075        ksqldb-cli                6 minutes ago       Up 6 minutes
9a1a8c4aa717        ksqldb-server             6 minutes ago       Up 6 minutes
acf9e1ba4a88        control-center            6 minutes ago       Up 6 minutes
04d7691eeee9        kafka-connect             6 minutes ago       Up 6 minutes
5630a4021627        schema-registry           6 minutes ago       Up 6 minutes
3b04af171960        broker                    6 minutes ago       Up 6 minutes
72b2fe66f381        mysql                     6 minutes ago       Up 6 minutes (healthy)
cb980461bd90        zookeeper                 6 minutes ago       Up 6 minutes
6e42d5206c65        workshop-docs-webserver   11 minutes ago      Up 11 minutes
----
...
There's an extra table here called `dc_out_of_stock_events` that not in the schema diagram above, we'll cover this table separately later on.
...
[source]
----
docker-compose logs -f db-trans-simulator
----
...
[source]
----
curl -s localhost:8083/connectors/mysql-source-connector/status | jq
----
...
We can use link:http://localhost:9021/clusters[Confluent Control Center, window=_blank] to confirm this.
...
== Lab 4: Creating a ksqlDB Application

#TODO: revoir text et image#
...
CLI v0.10.1, Server v0.10.1 located at http://ksqldb-server:8088
...
-------------------------------------------------------------
 ...
 dc_customers              | 3          | 1
 dc_products               | 3          | 1
 dc_purchase_order_details | 3          | 1
 dc_purchase_orders        | 3          | 1
 dc_sales_order_details    | 3          | 1
 dc_sales_orders           | 3          | 1
 dc_suppliers              | 3          | 1
 debezium_dbhistory        | 1          | 1
...
-------------------------------------------------------------
```
...
== Lab 5: Querying Streams with ksqlDB
...
== Lab 7: Joining Steams & Tables with ksqlDB
...
== Lab 8: Streaming Current Stock Levels
...
[
  {
    "header": {
      ...
      "schema": "`PRODUCT_ID` INTEGER KEY, `STOCK_LEVEL` INTEGER"
    }
  },
  {
    "row": {
...
== Lab 10: Streaming Recent Product Demand
...
+-----------------+-----------------+-----------------+-----------------+
|13:33:00         |13:36:00         |15               |10               |
|13:34:00         |13:37:00         |15               |10               |
|13:35:00         |13:38:00         |15               |1                |
|13:33:00         |13:36:00         |15               |11               |
|13:34:00         |13:37:00         |15               |11               |
|13:35:00         |13:38:00         |15               |2                |
|13:34:00         |13:37:00         |15               |21               |
|13:35:00         |13:38:00         |15               |12               |
|13:36:00         |13:39:00         |15               |10               |
|13:34:00         |13:37:00         |15               |26               |
|13:35:00         |13:38:00         |15               |17               |
|13:36:00         |13:39:00         |15               |15               |
|13:35:00         |13:38:00         |15               |22               |
|13:36:00         |13:39:00         |15               |20               |
|13:37:00         |13:40:00         |15               |5                |
|13:36:00         |13:39:00         |15               |28               |
|13:37:00         |13:40:00         |15               |13               |
|13:38:00         |13:41:00         |15               |8                |
...
== Lab 11: Streaming _"Out of Stock"_ Events
