...
== Lab 15 Elasticsearch

[IMPORTANT]
====
[source,subs="attributes"]
----
curl -i -X POST -H "Accept:application/json"     -H  "Content-Type:application/json" http://localhost:18083/connectors/     -d '{
        ...
        "config": {
             ...
             "transforms.ConvertTimeValue.format": "YYYY-MM-DD'\''T'\''HH:mm:ssZ"
        }
    }'
----
====
